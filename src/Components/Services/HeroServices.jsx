...
const HeroServices = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: "🎯",
      desc: "High-conversion PPC campaigns focused on ROI growth.",
    },
    {
      title: "Creative Content",
      icon: "🎨",
      desc: "Visual storytelling that builds strong brand identity.",
    },
    {
      title: "Growth Analytics",
      icon: "📈",
      desc: "Data-driven optimization for scalable business growth.",
    },
    {
      title: "Email Systems",
      icon: "✉️",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            We design modern digital strategies that help businesses scale faster,
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              <div className="group bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-10 h-[360px] flex flex-col justify-between hover:bg-white/10 transition-all duration-500">
                ...
                {/* ICON */}
                <div className="text-4xl w-14 h-14 flex items-center justify-center rounded-2xl bg-blue-600/20 group-hover:bg-yellow-400/20 transition">
                  {item.icon}
                </div>
                ...
                {/* CTA */}
                <div className="mt-6 text-sm font-semibold text-blue-400 group-hover:text-yellow-400 flex items-center gap-2 cursor-pointer">
                  View Strategy →
                </div>
              </div>
            </SwiperSlide>
